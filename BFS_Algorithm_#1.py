...
# Student Name: MUHAMMAD AQIL BIN MOHAMMAD ASHRAF
# Student ID: SD23052
# Section: 02G
# ------------------------------------------------------------
...
st.markdown("*Name:* MUHAMMAD AQIL BIN MOHAMMAD ASHRAF | *Student ID:* SD23052 | *Section:* 02G")
...
st.subheader("1️⃣ Graph Structure")
st.json(graph)
...
# ------------------------------------------------------------
st.subheader("2️⃣ Choose Traversal Type")
...
# ------------------------------------------------------------
st.markdown("---")
st.subheader("3️⃣ Algorithm Explanation")
